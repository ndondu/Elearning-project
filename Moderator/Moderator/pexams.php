...
<div class="app-main__outer">
    <div class="app-main__inner">
                    ...
                    <table class="align-middle mb-0 table table-borderless table-striped table-hover" id="tableList">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-left"><?php echo $row['exam_title']?></td>
                                <td class="text-left"><?php echo $row['course']?></td>
                                <td class="text-left"><?php echo $row['Description']?></td>
                                <td class="text-left"><?php echo $row['exam_datetime']?></td>
                                <td class="text-left"><?php echo $row['course']?></td>
        ...
        <td class="text-center">
                                ...
                                <button class="course-dash btn btn-primary" data-toggle="modal" data-target="#exampleModal2" style="border: none; float:right;"> &nbsp; Delete</button>
                            </td>
    </div>
                ...
                <div class="modal-content">
                    ...
                    <form action="../Includes/addexam.php" method="post" enctype="multipart/form-data">
                        <div class="modal-body">
                            ...
                            <div class="col-lg-12">
                                <input type="date" name="date_time" class="form-control" placeholder="Date time">
                            </div><br>
